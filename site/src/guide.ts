...
const PAGES: Array<{ id: string; title: string; playground?: string }> = [
  ...
  { id: 'bowl', title: 'The singing bowl & the breath', playground: 'bowl' },
...
const SECTION_PLAYGROUNDS: Record<string, string> = {
  ...
  'crust-is-not-a-tint': 'industrial',
  'wear-rain-on-everything': 'wear',
  'water-fills-from-the-bottom': 'wear',
  'driven-by-the-rain': 'wear',
  terrain: 'world',
  'water-shores': 'living',
  ...
  'distance-is-a-filter-not-a-volume-knob': 'stacks',
  'what-it-costs-the-person-standing-there': 'stacks',
  'the-era-axis-what-the-front-row-pays-for-the-back-row': 'stacks',
  'the-bill-is-time': 'stacks',
  'more-towers-flatter-field': 'stacks',
  'a-line-array-is-not-a-bigger-speaker': 'stacks',
  'what-a-wall-does-depends-on-the-wavelength': 'stacks',
  'the-field-handshake': 'stacks',
  'operate-it-and-it-plays-the-radio': 'booth',
  'the-dropout-is-the-design-problem': 'booth',
  'the-tiles-never-find-out': 'booth',
  'live-is-measured-not-trusted': 'booth',
  'what-runs-where': 'booth',
  'she-still-has-a-field': 'booth',
