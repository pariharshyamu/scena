const e=(t=30,a=16,r=.05)=>`game.onUpdate((t) => {
  const a = t.elapsed * ${r};
  game.camera.position.set(Math.cos(a) * ${t}, ${a}, Math.sin(a) * ${t});
  game.camera.lookAt(0, 2, 0);
});`,o=[{id:"world",title:"Terrain, sky & light",group:"Worldbuilding",code:`// A complete outdoor stage in a few calls: seeded low-poly terrain
...
${e(36,18)}
game.start();`},{id:"forest",title:"Scatter a forest",group:"Worldbuilding",code:`// Empty plane → forest in one call. Density noise gives natural
...
${e(34,17)}
game.start();`},{id:"wind",title:"Wind & swaying flora",group:"Worldbuilding",code:`// One WindField makes the whole scene breathe: a wheat field ripples,
...
game.start();`},{id:"weather",title:"Rain & snow",group:"Worldbuilding",code:`// GPU-driven precipitation: every drop is placed in the vertex shader
...
game.start();`},{id:"weathersys",title:"Weather controller",group:"Worldbuilding",code:`// One createWeather cross-fades the whole scene between named states —
...
game.start();`},{id:"seasons",title:"Season controller",group:"Worldbuilding",code:`// createSeasons is the weather controller's counterpart for the trees: it
...
game.start();`},{id:"ocean",title:"Sea waves",group:"Worldbuilding",code:`// A Gerstner-wave sea: crests peak and troughs flatten like real swell,
...
game.start();`},{id:"sail",title:"Sailing to windward",group:"Worldbuilding",code:`// Four rigs, six hundred years apart, in ONE breeze — all trying to reach
...
game.start();`},{id:"berth",title:"Alongside",group:"Worldbuilding",code:`// A rope is a ONE-WAY constraint: it pulls, and it can never push. A
...
game.start();`},{id:"oars",title:"Under oars",group:"Worldbuilding",code:`// An oar is not a throttle, it is a DUTY CYCLE: the blade is in the water
...
game.start();`},{id:"sea",title:"Sea state & swell",group:"Worldbuilding",code:`// THE SEA REMEMBERS AND THE WIND DOES NOT. A wind gets up in twenty minutes;
...
game.start();`},{id:"booth",title:"The booth, web radio & DJ tiles",group:"Worldbuilding",code:`// THE FIRST PROP IN THIS LIBRARY THAT IS NOT ALL HERE.
...
game.start();`},{id:"shala",title:"The shala: four rooms for one practice",group:"Worldbuilding",code:`// THE QUIETEST GATHERING IN THIS LIBRARY: no seats, no table, no fire —
...
game.start();`},{id:"bowl",title:"The singing bowl & the breath pulse",group:"Worldbuilding",code:`// THE WOOFER'S CALM OPPOSITE. The woofer publishes music as an
...
game.start();`},{id:"beach",title:"Miami: the beach kit, cloth palms & clean water",group:"Worldbuilding",code:`// MIAMI. The props that turn sand into a BEACH: pastel art-deco
...
game.start();`},{id:"stacks",title:"The PA, coverage & the echo",group:"Worldbuilding",code:`// THE FIRST PROP IN THIS LIBRARY THAT REACHES THE EAR.
...
game.start();`},{id:"plumbing",title:"Plumbing, pressure & the scald",group:"Worldbuilding",code:`// THE FIRST THING IN THIS LIBRARY THAT IS SOMEBODY ELSE'S FAULT.
...
game.start();`},{id:"coast",title:"Lights, sectors & the horizon",group:"Worldbuilding",code:`// A LIGHT IS A FACT ABOUT THE OBSERVER. It does nothing where it stands;
...
game.start();`},{id:"craft",title:"Small craft & swamping",group:"Worldbuilding",code:`// A SMALL BOAT IS NOT LOST TO STABILITY. SHE IS LOST TO FREEBOARD.
...
game.start();`},{id:"gear",title:"Working gear & girting",group:"Worldbuilding",code:`// A WORKING LOAD ACTS AT THE END OF A WIRE, AND IT CAN PULL YOU OVER.
...
game.start();`},{id:"liner",title:"The liner",group:"Worldbuilding",code:`// THE WHOLE BOAT ARC IN ONE HULL — and a coaster beside her in the same sea.
...
game.start();`},{id:"trim",title:"Trim & the free surface",group:"Worldbuilding",code:`// A HOLD FULL OF WATER IS SAFER THAN A HOLD HALF FULL OF IT. Four identical
...
game.start();`},{id:"steam",title:"Steam & cut-off",group:"Worldbuilding",code:`// FULL AHEAD IS NOT HER FASTEST. Two identical triples: one in full gear,
...
game.start();`},{id:"surge",title:"Storm surge",group:"Worldbuilding",code:`// The weather controller's storminess is wired into the ocean's storm, so a
...
game.start();`},{id:"underwater",title:"God rays, caustics & bubbles",group:"Worldbuilding",code:`// A reef: god rays fall as crossed additive shafts, caustics dance on the
...
game.start();`},{id:"flock",title:"Flocks & schools",group:"Worldbuilding",code:`// A boid flock — separation, alignment, cohesion + wander — drawn as one
...
game.start();`},{id:"herd",title:"Herds & grazing",group:"Worldbuilding",code:`// Ground-dwelling ambient life. A boid sim steers the herd across the
...
game.start();`},{id:"trees",title:"Tree species",group:"Worldbuilding",code:`// Thirteen seeded species from one createTree — pine, oak, cypress, birch,
...
game.start();`},{id:"lod",title:"Scatter LOD tiles",group:"Worldbuilding",code:`// Opt-in LOD: placements bucket into tiles; tiles beyond 'distance'
...
game.start();`},{id:"giants",title:"Giant forest impostors",group:"Worldbuilding",code:`// treeLOD pairs a full createTree with a billboard createImpostor — a
...
game.start();`},{id:"props",title:"Prop gallery",group:"Props",code:`// Every generator, one of each. All seeded (same seed = same prop),
...
${e(26,14,.06)}
game.start();`},{id:"surfaces",title:"Procedural surfaces",group:"Props",code:`// Why SCENA props can out-look a downloaded GLTF at a fraction of the
...
${e(20,11,.05)}
game.start();`},{id:"modern",title:"Modern materials & glass",group:"Props",code:`// The Tier-4 surfaces: fair-faced concrete with shutter joints, marble,
...
game.start();`},{id:"market",title:"A market & its statues",group:"Props",code:`// Two lifelike prop families: market stalls — striped canvas awnings
...
${e(18,8,.05)}
game.start();`},{id:"banners",title:"Flags & banners (waving)",group:"Props",code:`// Real cloth, not a stiff board: each flag is a subdivided plane rippled
...
${e(15,6,.04)}
game.start();`},{id:"fire",title:"Braziers & campfires",group:"Props",code:`// Fire at dusk: each flame is a particle-ish cluster of tongues rippling
...
game.start();`},{id:"fair",title:"A village fair",group:"Props",code:`// Three lifelike props together: a tiered stone fountain with animated
...
game.start();`},{id:"signs",title:"Signposts & stylised text",group:"Props",code:`// Real, legible lettering carved from an embedded vector font — no
...
game.start();`},{id:"palettes",title:"Retheme with palettes",group:"Props",code:`// One palette system themes every generator: the same four seeds,
...
${e(30,20,.04)}
game.start();`},{id:"village",title:"A seeded village",group:"Settlement",code:`// A hamlet from one call: well-anchored plaza, houses facing inward,
...
${e(26,13,.045)}
game.start();`},{id:"kit",title:"An ASCII fort (kits)",group:"Settlement",code:`// Interiors and compounds from ASCII: every character is one
...
${e(17,12,.05)}
game.start();`},{id:"skyline",title:"Downtown skyline",group:"Settlement",code:`// createHighrise: a multi-storey tower whose cost does NOT scale
...
game.start();`},{id:"bungalow",title:"Modern bungalows",group:"Settlement",code:`// createBungalow masses a seeded modern villa from the Tier-4
...
game.start();`},{id:"interior",title:"A cottage interior",group:"Settlement",code:`// createRoom takes the kit grid indoors — plastered walls over
...
game.start();`},{id:"living",title:"Water, wind & the day cycle",group:"Living world",code:`// The living-world trio: an animated lake with sandy shores, wind
...
${e(34,16)}
game.start();`},{id:"path",title:"A road & its wardens",group:"Living world",code:`// The SCENA handshake, live: ONE authored polyline becomes the dirt
...
${e(30,15)}
game.start();`},{id:"manifest",title:"A world from JSON",group:"Manifests",code:`// The entire world below is ONE plain-JSON object — storable,
...
${e(33,16,.045)}
game.start();`},{id:"cricket",title:"The cricket ground",group:"Props",code:`// A cricket field is mostly EMPTY, and the emptiness is measured: a
...
game.start();`},{id:"wear",title:"Wear: rain on everything",group:"Worldbuilding",code:`// WET IS A STATE, NOT A KIND. Every one of the 46 surface presets can be
...
game.start();`},{id:"industrial",title:"The industrial six",group:"Worldbuilding",code:`// Six kinds, four new pieces of shader — all off by default, all costing
...
game.start();`},{id:"physical",title:"The physical tier",group:"Worldbuilding",code:`// Six light responses MeshStandardMaterial has no term for at all —
...
game.start();`},{id:"environment",title:"Metal that is actually metal",group:"Worldbuilding",code:`// BACK ROW reflects, FRONT ROW does not. Same scene, same lights, same
...
game.start();`},{id:"feel",title:"Game feel: effects, trails, marks",group:"Living world",code:`// THE WORLD REACTS, AND THE WORLD REMEMBERS. Three systems:
...
};`},{id:"arcade",title:"Pickups & markers",group:"Living world",code:`// THE FURNITURE OF A GAME LOOP. createPickupField puts fourteen
...
};`},{id:"gauntlet",title:"Hazards & the pressure plate",group:"Living world",code:`// WHERE MOVEMENT ITSELF IS THE GAME. A rider crosses the moving
...
};`},{id:"smash",title:"Destructibles & the scoreboard",group:"Living world",code:`// FEEDBACK BY COMING APART. Every few seconds the unseen striker takes
...
};`},{id:"dusk",title:"Night falls on Main Street",group:"Living world",code:`// THE LIGHT BUDGET AT DUSK. Thirteen fixtures claim a real light;
...
};`},{id:"tempest",title:"Tempest & the fireworks after",group:"Living world",code:`// THE SKY'S DRAMA, in a loop: sixteen seconds of STORM — rain,
...
window.tempestStrike = () => storm.strike({ distance: 8, energy: 1 });`},{id:"grove",title:"The sunbeam grove",group:"Living world",code:`// ATMOSPHERE YOU CAN SEE. God rays slant through the canopy — every
...
};`},{id:"railway",title:"The branch line: track, consist & platform",group:"Living world",code:`// RAIL IS THE ONE VEHICLE CLASS THAT DOES NOT STEER. A train's whole
...
requestAnimationFrame(frame);`},{id:"airfield",title:"The airfield: circuits & the windsock",group:"Living world",code:`// THE VEHICLE KIT GROWS WINGS. A trainer flies the traffic pattern on
...
};`},{id:"heliport",title:"Night ops at the heliport",group:"Living world",code:`// THE HELICOPTER'S NIGHT SHIFT. Spool up (rotors take their time and
...
};`},{id:"jets",title:"Jets: the flypast",group:"Living world",code:`// THE FAST MOVERS. Two delta-wing fighters fly the display circuit in
...
};`},{id:"ammunition",title:"Ammunition: one table, four states",group:"Living world",code:`// THE SUPPLY CHAIN, NOT A SHELF OF MODELS.
//
...
`}];function s(t){return o.find(a=>a.id===t)??o[0]}export{o as E,s as f};
